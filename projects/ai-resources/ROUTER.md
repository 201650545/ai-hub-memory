# ROUTER.md — ai-resources 冷记忆路由索引
...
（暂空：截至 2026-08-28 无条目迁移入 archive。迁移发生时按下方维护规则同步新增一行。）

## Agent 怎么用（两种唤醒）

**A. 临时召回（＝MoE 的一次 expert activation）**
1. 用关键词在本表 `topic_keys` / `entities` 中查找命中行；
2. 按 `archive_ref` 打开正文（如 `archive/projects/ai-resources/2026/2026-08.md#S-20260829-05`）；
...
| archive-ai-resources-20260830 | incident | ai-resources-state-archive | ai-resources | 2026-08 | resolved | archive/projects/ai-resources/2026/2026-08.md + 2026-08-30.md | S-20260825-01..S-20260829-28 | | |
