# ROUTER.md — memory-system 冷记忆路由索引
...
> 当前 STATE 7 条（08-14~08-21）均处活跃期，无 ≥3-5 条归档批次，暂不迁移；已归档的历史（S-20260814-01/02/03/09/11/12/13/17/19 等 DROP 条目）细节保留于 CHANGELOG 流水，待形成批量后再补索引行。

## Agent 怎么用（两种唤醒）

**A. 临时召回（＝MoE 的一次 expert activation）**
1. 用关键词在本表 `topic_keys` / `entities` 中查找命中行；
2. 按 `archive_ref` 打开正文（如 `archive/projects/memory-system/2026/2026-08.md#S-xxxx`）；
