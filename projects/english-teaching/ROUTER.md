# ROUTER.md — english-teaching 冷记忆路由索引
...
> 当前 8 条 STATE 条目（08-19~08-21）均处活跃期，无 ≥3-5 条归档批次，暂不迁移，待自然沉淀后再补索引行。

## Agent 怎么用（两种唤醒）

**A. 临时召回（＝MoE 的一次 expert activation）**
1. 用关键词在本表 `topic_keys` / `entities` 中查找命中行；
2. 按 `archive_ref` 打开正文（如 `archive/projects/english-teaching/2026/2026-08.md#S-xxxx`）；
